...
<div class="register-container">
	...
	<div class="register-form-wrapper">
		...
		<div class="col-xs-12">
			{!! Form::model($hardware, [
				'action' => 'Admin\AdminHardwareController@update',
				'id' => 'signup-form',
				'files' => true])
			!!}
				<div class="register-form-container-featurette">
								...
								<div class="col-xs-12 form-group">
									...
									<select name="videos[]" id="videos-input" class="form-control" multiple>
										@foreach ($videos as $video)
											<option @if($hardware->videos->contains($video)) selected @endif value="{{ $video->id }}">{{ $video->name }}</option>
										@endforeach
									</select>
								</div>
							</div>
					...
					{!! Form::hidden('hardware-id', $hardware->id) !!}
